...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/diff_vapour.F90 $
!---------------------------------------------------------------------
!********************************************************************!


real*8 function diff_energybal (unk_ivol,unk_jvol,dens_ivol,dens_jvol,por_ivol,por_jvol, &
...
diff_energybal = - fluxdd(dunk,cinf,coeff)
