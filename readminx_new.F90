...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/readminx_new.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c ----------------------------------------------------------------------
      ...
      subroutine readminx_new(imdbs,ipsp,ilog,idbg)
...
1000  continue
      ...
      if (info_debug.gt.0) then
        ...
        do imx=1,nmx
          ...
          write(idbg,'(a,e10.3)') 'eqmxs  ',-dlog10(eqmxs(imx))
          write(idbg,'(a,e10.3)') 'dhcmx  ',dhcmx(imx)
