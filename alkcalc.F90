...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/alkcalc.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c ----------------------------------------------------------------------
      ...
      real*8 :: alk_carb,alk_noncarb,alk_tot,alk_carb_mg,              &
                alk_noncarb_mg,alk_tot_mg, alkfacc,alkfacx,c,cx
      integer :: iax,jax,nc,nx

      character*72, namec, namex
      logical carb_alkalinity

      dimension alkfacc(*), alkfacx(*), c(*), cx(*), &
               iax(*), jax(*), namec(*), namex(*)
