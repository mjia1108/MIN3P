...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/readmin.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c ----------------------------------------------------------------------
      ...
      dimension xnumt(10),ordt(10),value(10),value2(10)
...
!c  from seconds to days
                ...
                elseif (rate_control(im).eq.'transport') then
                  ...
                  read(imdbs,*,err=999) ndt, ndc, ndcx, diffm(ireac), &
     &                          xnud(ireac)
...
!c  echo check dissolution/precipitation reactions
     ...
     &                                 ' diffm ',r86400*diffm(i)       
            elseif (rate_control(im).eq.'transport') then              
              write(idbg,'(i5,a,e10.3)') i,' xnud ',xnud(i)            
            end if                                                     
