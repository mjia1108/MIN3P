...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/dens.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c           tds_old2(nn)       = total dissolved solids [mg/L]       
!c                                at previous time step N-1
!c           tol_sia            = Picard iteration convergence tolerance
!c           tot_tds            = total dissolved solids [mg/L]
...
!c ----------------------------------------------------------------------
    ...
    real (type_r8), allocatable :: totc_init(:)
