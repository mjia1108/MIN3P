...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/infcrt_g.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c --------------------------------------------------------------------------
      ...
      logical half_cells, tortuosity_corr, assigned_tau,radial_coord, &
              oil_saturation, dual_permeability
      ...
      real*8  diffu, pornew(nmax), sgnew(nmax),                       &
              ...
              so_av, tauav, tort, xg(nmax), yg(nmax)
...
!c     local variables
      ...
      real*8 r0, r1, r2, rverysmall, tiny
      parameter (r0 = 0.0d0, r1 = 1.0d0, r2 = 2.0d0,                  &
                 rverysmall = 1.0d-30, tiny = 1.0d-10)
