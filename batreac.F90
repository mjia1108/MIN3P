...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/batreac.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c ----------------------------------------------------------------------
      ...
      integer :: i, ic, ilz, ivol, l_string, nlz, tid 
...
!c  compute initial condition
          ...
          call gcreact(ccnew,ccold,cxc,gamma_l(1),gamma_l(nc+1),      &
                     cgc,swc,sac,pornew(ivol),igen,ilog,tid,idbg,     &
                     tec_header,prefix,l_prfx,zone_name,l_zone_name)

!          call gcreact(ccnew,ccold,cxc,gamma_l(1),gamma_l(nc+1),     &
!                    cgc,r1,r0,r1,igen,ilog,tid,idbg,                 &
!                    tec_header,prefix,l_prfx,zone_name,l_zone_name)
...
!CMXb
    ...
    !$omp do schedule(static)
              ...
              do ivol = 1,nngl         !loop over control volumes
                ...
                call gcreact(ccnew,ccold,cxc,gamma_l(1),gamma_l(nc+1),&
                             cgc,swc,sac,pornew(ivol),igen,ilog,tid,  &
