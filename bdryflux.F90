...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/bdryflux.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c                                           conditions
!c           dual_permeability  = .true.  -> dual_permeability        + -
!c
!c           character:
!c           ----------
...
!c ----------------------------------------------------------------------
      ...
      real*8 :: fluxvs, fluxfs, fluxvs_dp
      ...
      external ::  fluxvs, fluxfs, fluxvs_dp
