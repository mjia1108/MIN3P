...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/driver_pc.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
Program driver_pc
...
#ifdef PETSC
     use solver_dd, only : solver_dd_snes_create_flow,                 &
     ...
     use solver_lis, only : solver_lis_initialize,                     &
      ...
      integer :: i, ivol, igb, ierrcode, tid
      logical :: bflag
...
#ifdef DEBUG
      write(*,*) "Number of threads used ",numofthreads_global
      write(ilog,*) "Number of threads used ",numofthreads_global
#endif
#endif
