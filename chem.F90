...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/chem.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c           diss_vol           = .true.  -> adjust dissolution precipitation
!c                                           rates to ensure mass balance
...
!c ----------------------------------------------------------------------
      ...
      real (type_r8), allocatable :: srelfac_lc(:)
      real (type_r8) :: tempc
      real (type_r8) :: tempk
      ...
      integer (type_i4), allocatable :: maxit_lc(:)
      integer (type_i4), allocatable :: idetail_lc(:)
...
!c                                concentrations 
!c                                - old time level [moles/l water]
!c           totco_init(n,nbzrt)  = initial boundary condition of total 
...
!c ----------------------------------------------------------------------
      ...
      real (type_r8), allocatable :: totco_init(:,:)
...
!c ----------------------------------------------------------------------
      ...
      real (type_r8) :: moleconcorr_min
      real (type_r8) :: moleconcorr_max
