...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/readint_new.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c local:    real*8:
!c           -------
!c           value(10)          = array for temporary storage of
!c                                reaction orders
!c           value2(10)         = array for temporary storage of
!c                                reaction orders
!c           r0                 = constant
!c           r10                = constant
!c           r86400             = constant
!c           xnut(10)           = array for temporary storage of
...
!c ----------------------------------------------------------------------
      ...
      real*8 :: dummy
      real*8 :: xnut(10), value(10), value2(10), ntsct2(10),ordt(10),  &
                alphat(10,10), iinum(10)
...
!cdbg ---- activate this section for purposes of debugging -----
      ...
      do iaq=1,naq
          ...
          write(idbg,'(a,e10.3)') 'eqaqs   ',eqaqs(iaq)
          write(idbg,'(a,e10.3)') 'dhaq    ',dhaq(iaq)
          write(idbg,'(a,e10.3)') 'dgaq    ',dgaq(iaq)
          write(idbg,'(a,i10)') 'iaaq    ',iaaq(iaq)
          write(idbg,'(a,e10.3)') 'ratecaqs',dlog10(ratecaqs(iaq))
...
!c  hyperbolic terms phi^m
          ...
          do i2 = istart2,istop2
            icur = jaaqhm(i2)
            write(idbg,'(i5,2x,a72,a,i5,2(a,e10.3))') i2,namem(icur), &
     &                                        ' jaaqhm ',jaaqhm(i2),  &
     &                                        ' faqhm ',faqhm(i2),    &
     &                                        ' ordaqhm ',ordaqhm(i2) 
          end do
