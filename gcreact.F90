...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/gcreact.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c ----------------------------------------------------------------------
      ...
      integer :: igen,ilog,tid,idbg,l_prfx,l_zone_name
...
!c  update solution vector
            ...
            call updatelc(cnew,blc(:,tid),ilog,tid,not_converged,zone_name)
        ...
        if(rank == 0) then  
          if (lb_output .and. ph_sweep .and. b_enable_output) then
            ...
            call tprfrtlc(totcn(:,tid),cnew,cx,gammac,gammax,          &
                     ...
                     prefix,l_prfx,tec_header,0,                       &
                     tid,iph_steps,iph_steps+1,                        &
