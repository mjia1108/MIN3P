...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/modrate.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c           logical:
!c           --------
!c           diss_vol           = .true.  -> adjust dissolution       + - 
!c                                           precipitation
!c                                           rates to ensure 
!c                                           mass balance
...
!c  depletion of mineral
     ...
     &     (reaction_type(im).eq.'dissolution_to_equilibrium') ) then
          ...
          if ((cmnewm+dissvol).lt.(r1+small)*cmcmin(im,tid) .and.      &
     &        diss_vol) then
