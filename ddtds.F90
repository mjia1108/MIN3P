...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/ddtds.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c ----------------------------------------------------------------------
      ...
      real*8,parameter :: r0 = 0.0d0, r1 = 1.0d0,                     &
                           visc_h2o = 1.0d-3, visc_coef1 = 1.85d0,     &
                          visc_coef2 = -4.1d0, visc_coef3 = 4.45d1  
...
!c clear density and viscosity vectors
    ...
    !   call zero_r8_parallel(tds_new,nngl,1,1)
      ...
      if (update_viscosity) then
        call zero_r8_parallel(viscosity,nngl,1,1)
      end if
