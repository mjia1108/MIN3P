...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/opnenergybal.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c  system energy
      ...
      if (rank == 0 .and. b_enable_output .and. b_output_trans_binary) then
        allocate(imheat_mpi(imheat_first:imheat_first+2))  
        imheat_mpi = -1
        allocate(offset_imheat(imheat_first:imheat_first+2)) 
        offset_imheat = 0
        allocate(offset_imheat_ijk(imheat_first:imheat_first+2)) 
        offset_imheat_ijk = 0
      end if
