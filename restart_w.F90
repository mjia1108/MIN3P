...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/restart_w.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
#include <finclude/petscsys.h>
      ...
      integer :: ibu1, ibu2, ivol, ic, ig, im, izn
    ...
    if (rsrt_cnt.eq.ibu1.or.rsrt_cnt.eq.ibu2) then
     ...
     if (rsrt_cnt.eq.ibu1) then
      ...
      if (b_binary_restart_write) then
        ...
        if (b_distributed_restart_write) then
          allocate(realbuffer_irsrt(nvars_irsrt*nngl))  
        else
          allocate(realbuffer_irsrt(nvars_irsrt*nn))    
        end if
