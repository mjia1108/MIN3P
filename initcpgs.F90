...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/initcpgs.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c           logical:
!c           --------
!c           dual_permeability  = .true.  -> carry out dual 
!c                                           permeability simulation  * +  
...
!cummj_dp  default setting - no dual permeability formulation            
      dual_permeability = .false.
...
!cummj_dp  set up for dual permeability simulation

      subsection = 'dual permeability'
      
      call findstrg(subsection,itmp,found_subsection)

      if (found_subsection) then
        dual_permeability = .true.
      end if
