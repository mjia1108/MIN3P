...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/trans_evap_info.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c  version information
  ...
  if (b_output_trans_binary) then
    ...
    write(ievap,'(14e15.6e3)') time_io,evaploc,temp_atm,hr_atm,windloc,rainloc,    &
                             runoffloc,seepage,densv_atm,pvloc,radnetloc,levaploc, &
                             hsloc,total  
  end if     
