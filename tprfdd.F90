...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/tprfdd.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
#include <finclude/petscsys.h>
      ...
      real*8 :: qroot, theta_a, theta_g, rootwat, phead, fhead, actw,  &
                dummy, dummy2, dummy3, dummy4, pv
      ...
      if (ioutdebug .eq. 0) then  !tprfvs format - no fluid pressures
        ...
        if (fully_saturated) then
          ...
          if (b_output_trans_binary) then
            ...
            write(igbp,'(5e15.6e3)') time_io,fhead, uvsnew(ivol),      &
                                   sanew(ivol),theta_a
          end if
        ...
        elseif (variably_saturated) then
          ...
          if (b_output_trans_binary) then
            ...
            write(igbp,'(8e15.6e3)') time_io,fhead,uvsnew(ivol),       &
                                      sanew(ivol),theta_a,             &
                                      sgnew(ivol), theta_g, qroot
          end if                                                             
        end if
      ...
      if (ioutdebug .eq. 1) then                                       
        if (fully_saturated) then
          if (b_output_trans_binary) then
            ...
            write(igbp,'(7e15.6e3)') time_io,fhead, uvsnew(ivol),      &
                                   phead,density(ivol),                &
                                   sanew(ivol),theta_a
          end if                                                             
        elseif (variably_saturated) then
          ...
          if (evaporation) then                                        
            ...
            if (b_output_trans_binary) then                                  
              ...
              write(igbp,'(14e15.6e3)') time_io,fhead,uvsnew(ivol),    &
                                phead, density(ivol),                  &
                                sanew(ivol),theta_a,sgnew(ivol),       &
                                theta_g,qroot,tempnew(ivol),           &
                                densvnew(ivol),actw,pv  
            ...
            if (b_output_trans_binary) then
              ...
              write(igbp,'(10e15.6e3)') time_io,fhead,uvsnew(ivol),    &
                                 phead, density(ivol),                 &
                                 sanew(ivol),theta_a,sgnew(ivol),      &
                                 theta_g, qroot
            end if
