...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/initcprt.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c  mass balance - explicit update dissolution-precipitation reactions 
...
!cdsu----------------------------------------------------
        ...
        subsection = 'explicit update of mineral volume fractions'
