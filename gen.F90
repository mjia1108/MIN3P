...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/gen.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!           dual_permability   = .true.  -> carry out dual 
...
!cprovi Ice sheet 
!cprovi Sergio Andres Bea Jofre 
!cdsu   Add iabvs_ice and jabrt_ice to set those volumes in affected area
...
!>dsu----------------------------------------------------------
    ...
    !> (f)->(d)
    !> Size nngl
    integer(type_i4), allocatable :: node_idx_lb2pg(:)
...
!c  file unit for writing transient data (*.gfvel, *.gcvel, *ggvel) 
    integer(type_i4), allocatable :: igfvel(:)
    integer(type_i4), allocatable :: igcvel(:,:)
    integer(type_i4), allocatable :: iggvel(:,:)    
    
!c  offset for writing transient data (*.gfvel, *.gcvel, *.ggvel) 
    ...
    integer*8, allocatable :: offset_iggvel(:,:)
    integer*8, allocatable :: offset_iggvel_temp(:,:)
    integer*8, allocatable :: offset_iggvel_ijk(:,:)
