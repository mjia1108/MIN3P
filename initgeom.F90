...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/initgeom.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!cdbg
      ...
      !  write(idbg,'(a,1x,1pe12.3)') 'areac(im)   ', areac(im)
      !  write(idbg,'(a,1x,1pe12.3)') 'phic(im)    ', phic(im,tid)
      !  write(idbg,'(a,1x,1pe12.3)') 'phimin(im)  ', phimin(im)
      !  write(idbg,'(a,1x,1pe12.3)') 'phiinit(im) ', phiinit(im,tid)
      !  write(idbg,'(a,1x,1pe12.3)') 'phinuc(im)  ', phinuc(im)
      !  write(idbg,'(a,1x,1pe12.3)') 'cmcnew(im)  ', cmcnew(im,tid)
      !  write(idbg,'(a,1x,1pe12.3)') 'cmcold(im)  ', cmcold(im,tid)
      !  write(idbg,'(a,1x,1pe12.3)') 'rads(im)    ', rads(im,tid)
      !  write(idbg,'(a,1x,1pe12.3)') 'radi(im)    ', radi(im)
      !end if
