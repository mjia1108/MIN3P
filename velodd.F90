...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/velodd.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c  passed variables
      ...
      integer nvx, nvy, nvz, njavs, nn, nn_loc, iavs(nn+1),           &
              javs(njavs), idbg, ilog, ivel, iprint  
...
!c  ouputdd routine: iprint = 1; else iprint = 0
            ...
            if (iprint .eq. 1) then
              ...
              if (b_output_binary) then
                ...
                write(ivel,'(9e15.6e3)') xg_out,yg_out,zg_out,         &
                                     (vel(idim),idim=1,3),             &
...
#ifdef DEBUG                                                 
                  write(idbg,'(i6,7e15.6e3)') ivol2,time_io,          &
