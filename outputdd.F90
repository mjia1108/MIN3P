...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/outputdd.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
#include <finclude/petscsys.h>
      ...
      real*8 :: dvi, qroot, ddens, ddens_c, ddens_dt, ddens_temp,      &
...
!cprovi--------------------------------------------------------               
     ...
     &                          (cdens3-tempk2*cdens4)) - ddens_temp  
            ...
            if (b_output_binary) then
              ...
              write(idens,'(50e15.6e3)') xg(ivol),yg(ivol),zout,       &
                    ddens_dt,ddensmix_dt,ddensreact_dt,                &
...
!c  assign depth coordinate in terms of depth or elevation
          ...
          if (fully_saturated) then
            if (b_output_binary) then
              ...
              if(heat_transport) then
                write(igsp,'(9e15.6e3)') xg(ivol),yg(ivol),zout,fhead, &
                                       phead, sanew(ivol),theta_w,     &
                                       tempnew(ivol),viscosity(ivol)
              else
                write(igsp,'(7e15.6e3)') xg(ivol),yg(ivol),zout,fhead, &
                                       phead, sanew(ivol),theta_w 
              end if
            end if                                                           
          elseif (variably_saturated) then
            ...
            if (b_output_binary) then
              ...
              write(igsp,'(12e15.6e3)') xg(ivol),yg(ivol),zout,fhead,  &
                                    phead,sanew(ivol),theta_w,         &
                                    sgnew(ivol), theta_g, qroot
            end if
          ...
          if (fully_saturated) then
           if (heat_transport) then 
             if (b_output_binary) then
               ...
               write(igsp,'(13e15.6e3)') xg(ivol),yg(ivol),zout,fhead, &
                                   uvsnew(ivol), phead,                &
                                   density(ivol),sanew(ivol),theta_w,  &
                                   snnew(ivol),theta_n ,tempnew(ivol), &
                                   viscosity(ivol) 
             ...
             if (b_output_binary) then
               ...
               write(igsp,'(11e15.6e3)') xg(ivol),yg(ivol),zout,fhead, &
                                   uvsnew(ivol), phead,                &
                                   density(ivol),sanew(ivol),theta_w,  &
                                   snnew(ivol), theta_n 
             end if
          ...
          elseif (variably_saturated) then
            ...
            if (heat_transport) then                                     
              ...
              if (b_output_binary) then
                ...
                write(igsp,'(14e15.6e3)') xg(ivol),yg(ivol),zout,fhead,&
                                    uvsnew(ivol), phead,               &
                                    density(ivol), sanew(ivol),theta_w,&
                                    sgnew(ivol),theta_g,               &
                                    snnew(ivol),theta_n,qroot
