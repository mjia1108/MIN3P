...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/readredx.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c local:    real*8:
!c           -------
!c           ctmp(10)           = array for temporary storage of
...
!c ----------------------------------------------------------------------
      ...
      dimension ctmp(10), xnut(10), ordt(10)
...
!cdbg ---- activate this section for purposes of debugging -----
      ...
      if (info_debug.gt.0) then
        do ir=1,nr
          ...
          write(idbg,'(a,e10.3)') 'eqrs  ',dlog10(eqrs(ir))
          write(idbg,'(a,e10.3)') 'dhcr  ',dhcr(ir)
...
!c  echo check reactions
          ...
          do i = istart, istop
            ...
            write(idbg,'(2(a,e10.3,1x))') 'bcatfac ',dlog10(bcatfac(i)),& 
     &                                    'rateox ',dlog10(rateox(i))
