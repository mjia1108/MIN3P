...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/infheat_d.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
! ----------------------------------------------------------------------
      ...
      real*8 fluxdd,heatcapw,vmag2,ups_heat,areadloc 
...
!  loop over control volumes   
    ...
    !$omp firstprivate(areax, aread, areadloc,                        &
    !$omp areai, delp_dd, delz_dd, dflux, dist, disx_avg, disy_avg,   &
    !$omp disz_avg, dl, dth, dtv, fvpair, porav, rho_av, satav,       &
