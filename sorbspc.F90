...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/sorbspc.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c ----------------------------------------------------------------------
      ...
      subroutine sorbspc(csb_ion,csb_surf,cec,eqsb_ion,eqsb_surf,gammac,c,xnusb_ion,xnusb_surf,   &
                         iasb_ion,iasb_surf,jasb_ion,jasb_surf,nsb_ion,nsb_surf,isb_ion,isb_surf, &
                         sorption_type_ion,sorption_type_surf,sorption_group,isactcexch)
...
!c definition of variables: (see above)
    ...
    subroutine sorbspc_m(csb_ion,csb_surf,cec,cec_fraction,eqsb_ion,eqsb_surf,    &
                         gammac,c,xnusb_ion,xnusb_surf,iasb_ion,iasb_surf,jasb_ion,jasb_surf,    &
                         nsb_ion,nsb_surf,isb_ion,isb_surf,sorption_type_ion,sorption_type_surf, &
