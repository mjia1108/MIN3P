...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/initppvs.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
#include <finclude/petscsys.h>
      ...
      real*8 :: r0, r1, rdummy, qroot_tot_max, convk
...
!c  write parameters for variably saturated flow to generic output file
     ...
     &        'fitting parameter REW_0:     ',' = ',rew0(izn),        &
     &        'fitting parameter p1:        ',' = ',p1(izn),          &
