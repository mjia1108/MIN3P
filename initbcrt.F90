...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/initbcrt.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!---------------------------------------------------------------------------------      
!---------------------------------------------------------------------------------      
      if (compute_ice_sheet_loading .and. ice_sheet%istotbc) then
...
!cdsu------------------------------------------------------------------
        ...
        phguess=7.0d0
        call guess(ccnew,ccold,tempks,ilog,tid)
        call setsize(redox_equil_lc)
        sac=r1
        sgc=r0
        porc=r1
