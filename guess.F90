...
!> $URL: https://biot.eos.ubc.ca/svn/min3p_thcm/branches/dsu_dual_permeability/src/min3p/guess.F90 $
!---------------------------------------------------------------------
!********************************************************************!
...
!c  assign fixed free species activities and concentrations
        ...
        elseif (ctype(ic).eq.'po2'.and.namec(ic).eq.'o2(aq)') then
          ...
          !From min3p dgm version, but no reference is available
          actv(ic) = r10**(-2.8980d0)*totco(ic,tid)
          !Here we use min3p dgm version, DSU, 2015-03-25
